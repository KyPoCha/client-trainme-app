...
export const ImageUpload = (props) => {
  ...
  const uploadImageToTrainer = async () => {
    let formData = new FormData();
    formData.append("file", file);
    axios
      .post(`${IMAGE_URL}${trainerImageId}`, formData, {
        headers: {
  ...
  return (
    <div className="image-upload">
      ...
      <div className="image-upload-body">
        <h2 className="image-upload-title">Upload a file</h2>
        <p className="image-upload-description">Attach the file below</p>
        <button className="upload-area">
          ...
          <label className="upload-area-description" for="image">
            You can select a file by <br />
